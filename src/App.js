...
function App() {
  const baseUrl="http://localhost/apiRes/";
...
<br/>
      <button className="btn btn-success" onClick={()=>abrirCerrarModalInsertar()}>Insertar Plato</button>
      <br /><br />
    ...
    <Modal isOpen={modalInsertar}>
      <ModalHeader>Insertar Plato</ModalHeader>
      <ModalBody>
